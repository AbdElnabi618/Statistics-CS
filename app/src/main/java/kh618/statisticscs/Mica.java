...
public class Mica extends android.support.v4.app.Fragment {
    ViewPag  pag;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
         v = inflater.inflate(R.layout.activity_mica,container,false);
        db = new InternalDB(v.getContext());
        adabter = new SubjectAdabter(getContext(),R.layout.subject_list,db.getMechanics("Lecture"));
        adabter2 = new SubjectAdabter(getContext(),R.layout.subject_list,db.getMechanics("Section"));
